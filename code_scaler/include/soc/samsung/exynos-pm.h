...
extern u32 acpm_get_sicd_mifdn_count(void);
...
#else
static inline u32 acpm_get_sicd_mifdn_count(void) { return 0; }
...
struct exynos_pm_info {
	...
	void __iomem *gic_en_base;	/* GIC_ISENABLEn base to check wkup */
	void __iomem *gic_pend_base;			/* GICD_ISPENDRn base to check wkup reason */
